  ...
  for (const adv of advDefs) {
    const r = await db.advancePayment.create({
      data: {
        ...
        exchangeRate: money(adv.rate),
        baseCurrencyAmount: money(adv.origAmt * adv.rate),
        payerType: adv.payerType,
        invoiceStrategy: adv.invStrategy,
        collectionStatus: adv.collStatus,
        writeOffStatus: adv.woStatus,
        status: "CONFIRMED",
        collectedAmount: money(adv.collected),
        remark: adv.remark,
  ...
  const invDefs = [
    {
      ...
      issueDate: "2026-03-31", delStatus: "DELIVERED", verifyStatus: "VERIFIED",
    ...
    },
    {
      ...
      issueDate: "2026-06-30", delStatus: "DELIVERED", verifyStatus: "PENDING",
      pool: "OUTPUT", entry: "SYSTEM",
    },
    {
      ...
      issueDate: "2026-07-05", delStatus: "PENDING", verifyStatus: "PENDING",
      pool: "OUTPUT", entry: "SYSTEM",
    },
  ];
  ...
  const inputInvDefs = [
    {
      ...
      issueDate: "2026-07-05", status: "VERIFIED", verify: "VERIFIED", deduct: "DEDUCTED",
      entry: "MANUAL", pool: "INPUT", items: [{ name: "国内货物运输服务", qty: 1, price: 7339.45, taxRate: 9 }],
    },
    {
      ...
      issueDate: "2026-07-06", status: "PENDING_VERIFY", verify: "PENDING", deduct: "PENDING",
      entry: "OCR", pool: "INPUT", items: [{ name: "仓储服务费", qty: 1, price: 4716.98, taxRate: 6 }],
    },
    {
      ...
      issueDate: "2026-07-07", status: "VERIFY_FAILED", verify: "VERIFY_FAILED", deduct: "PENDING",
      entry: "MANUAL", pool: "INPUT", fromTax: true,
      items: [{ name: "关务服务费", qty: 1, price: 11320.75, taxRate: 6 }],
    },
    {
      ...
      issueDate: "2026-06-15", status: "VERIFIED", verify: "VERIFIED", deduct: "DEDUCTED",
      entry: "MANUAL", pool: "INPUT",
      items: [
    ...
    },
    {
      ...
      issueDate: "2026-05-20", status: "VERIFIED", verify: "VERIFIED", deduct: "PENDING",
      entry: "MANUAL", pool: "INPUT", isAdv: true, costType: "代垫成本",
      items: [{ name: "代理服务费", qty: 1, price: 28301.89, taxRate: 6 }],
    },
  ];
